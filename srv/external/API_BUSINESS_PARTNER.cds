/* checksum : 711465fb2ebb131b2e527d1908d9870b */
@cds.external : true
...
entity API_BUSINESS_PARTNER.A_BusinessPartner {
  ...
  /**
   * Attribute that determines the format for printing correspondence with a business partner.
   * 
   * The values you choose using the input help are used in subsequent processes. You can choose how the data should be printed or sent:In BrailleIn large print
   */
  @sap.display.format : 'UpperCase'
   ...
   * Key for name prefix.
   * 
   * You can define a key for the name prefix in Customizing.
   */
  @sap.display.format : 'UpperCase'
